...
type UserLoginResponse struct {
	...
	StatusMessage string `protobuf:"bytes,2,opt,name=status_message,json=statusMessage,proto3" json:"status_message,omitempty"` // 状态消息
}
...
func (x *UserLoginResponse) GetStatusMessage() string {
	if x != nil {
...
var file_user_proto_rawDesc = []byte{
	...
	0x32, 0x80, 0x01, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x39, 0x0a, 0x08, 0x55, 0x73,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.Users.UserInfo:input_type -> user.UserInfoRequest
	2, // 1: user.Users.UserLogin:input_type -> user.UserLoginRequest
	1, // 2: user.Users.UserInfo:output_type -> user.UserInfoResponse
	3, // 3: user.Users.UserLogin:output_type -> user.UserLoginResponse
